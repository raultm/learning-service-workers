function setOffline (checked) {
    ...
    if (checked) {
      ...
      navigator.serviceWorker.register('/001_register_sw/sw.js').then(function (registration) {
      ...
      navigator.serviceWorker.getRegistration("/001_register_sw/sw.js").then(function (reg) {
